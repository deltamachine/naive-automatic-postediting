...
def main():
	...
	bd_postedits = '/home/deltamachine/Desktop/gsoc18/toolbox/bel-rus_data/bel-rus-cleaned_bel-rus-bidix_entries.txt'
	grammar_postedits = '/home/deltamachine/Desktop/gsoc18/toolbox/bel-rus_grammar-pe-context.json'
	other_postedits = '/home/deltamachine/Desktop/gsoc18/toolbox/bel-rus_other-pe-context.json'

	mt_string = input()

	bidix_postedits = process_bd_postedits(bd_postedits)
