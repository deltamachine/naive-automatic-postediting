...
def main():
	...
	bidix_postedits = process_bd_postedits('bel-rus_bidix-entries.txt')
	grammar_postedits = process_other_postedits('bel-rus_grammar-context.json')
	other_postedits = process_other_postedits('bel-rus_other-context.json')
